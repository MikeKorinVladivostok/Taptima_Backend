...
class __TwigTemplate_300e0571305aaa7d9a8d413a8a5fc93d794b67e38ecb225b3fd4401a04c89664 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"small-box ";
        ...
        <div class=\"icon\">
            ";
        // line 30
        echo $this->extensions['Sonata\AdminBundle\Twig\Extension\IconExtension']->parseIcon(twig_get_attribute($this->env, $this->source, (isset($context["settings"]) || array_key_exists("settings", $context) ? $context["settings"] : (function () { throw new RuntimeError('Variable "settings" does not exist.', 30, $this->source); })()), "icon", [], "any", false, false, false, 30));
        echo "
        </div>
        <a href=\"";
        // line 32
...
{% endblock %}
", "@SonataAdmin/Block/block_stats.html.twig", "W:\\domains\\Taptima_Backend\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\Block\\block_stats.html.twig");
    }
}
