...
class __TwigTemplate_f580dcfc747e98303693cbac215bae5ba5e50632a07eacf35516d8888287fa98 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_relation_link($context, array $blocks = [])
    {
        ...
        echo "\">";
        // line 37
        echo twig_escape_filter($this->env, $this->extensions['Sonata\AdminBundle\Twig\Extension\RenderElementExtension']->renderRelationElement((isset($context["element"]) || array_key_exists("element", $context) ? $context["element"] : (function () { throw new RuntimeError('Variable "element" does not exist.', 37, $this->source); })()), (isset($context["field_description"]) || array_key_exists("field_description", $context) ? $context["field_description"] : (function () { throw new RuntimeError('Variable "field_description" does not exist.', 37, $this->source); })())), "html", null, true);
        // line 38
        echo "</a>";
...
{%- block relation_value -%}
    {{- element|render_relation_element(field_description) -}}
{%- endblock -%}
", "@SonataAdmin/CRUD/Association/list_many_to_many.html.twig", "W:\\domains\\Taptima_Backend\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\Association\\list_many_to_many.html.twig");
    }
}
