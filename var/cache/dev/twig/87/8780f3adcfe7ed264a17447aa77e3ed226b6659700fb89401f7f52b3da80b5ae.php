...
class __TwigTemplate_365ae012441c7e86451f3bdbabfe416a765d2a55a1c5f5aac9e8fecb6c2e18b3 extends Template
{
    private $source;
    private $macros = [];
...
{% if admin.hasAccess('create') and admin.hasRoute('create') %}
    ...
    {% endif %}
{% endif %}
", "@SonataAdmin/Button/create_button.html.twig", "W:\\domains\\Taptima_Backend\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\Button\\create_button.html.twig");
    }
}
