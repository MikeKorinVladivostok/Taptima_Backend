...
class __TwigTemplate_0a93ab9c4d68269dbc855fe153305c1a8e0ff64b8831ace2b0f66b95639cc30b extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_field_span_attributes($context, array $blocks = [])
    {
        ...
        if (((isset($context["is_editable"]) || array_key_exists("is_editable", $context) ? $context["is_editable"] : (function () { throw new RuntimeError('Variable "is_editable" does not exist.', 18, $this->source); })()) && (isset($context["x_editable_type"]) || array_key_exists("x_editable_type", $context) ? $context["x_editable_type"] : (function () { throw new RuntimeError('Variable "x_editable_type" does not exist.', 18, $this->source); })()))) {
            ...
            echo "'}]\"
        ";
            $___internal_f1870c19110cc04c97738e89fd3fd48700468e607f397961c830d01933cdd5d9_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
            // line 19
            echo twig_spaceless($___internal_f1870c19110cc04c97738e89fd3fd48700468e607f397961c830d01933cdd5d9_);
            // line 23
            echo "    ";
        }
...
{% endblock %}
", "@SonataAdmin/CRUD/list_boolean.html.twig", "W:\\domains\\Taptima_Backend\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\list_boolean.html.twig");
    }
}
