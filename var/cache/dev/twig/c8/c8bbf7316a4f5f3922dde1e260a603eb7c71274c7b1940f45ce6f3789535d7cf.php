...
class __TwigTemplate_e8b6e2cfba9bc4a822d54d9a36c4529ce0df448885d82477c0712afa50814a52 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if ((null === (isset($context["value"]) || array_key_exists("value", $context) ? $context["value"] : (function () { throw new RuntimeError('Variable "value" does not exist.', 13, $this->source); })()))) {
            ...
            // line 16
            echo twig_escape_filter($this->env, (((isset($context["currency"]) || array_key_exists("currency", $context))) ? (_twig_default_filter((isset($context["currency"]) || array_key_exists("currency", $context) ? $context["currency"] : (function () { throw new RuntimeError('Variable "currency" does not exist.', 16, $this->source); })()), null)) : (null)), "html", null, true);
            echo " ";
        ...
        $___internal_d208ff6d824ece00e1872a7856578a5b6f296094e0028fe9ff53b1311d0a286e_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        // line 12
        echo twig_spaceless($___internal_d208ff6d824ece00e1872a7856578a5b6f296094e0028fe9ff53b1311d0a286e_);
...
{%- apply spaceless %}
    ...
    {%- endif -%}
{% endapply -%}
", "@SonataAdmin/CRUD/display_currency.html.twig", "W:\\domains\\Taptima_Backend\\vendor\\sonata-project\\admin-bundle\\src\\Resources\\views\\CRUD\\display_currency.html.twig");
    }
}
