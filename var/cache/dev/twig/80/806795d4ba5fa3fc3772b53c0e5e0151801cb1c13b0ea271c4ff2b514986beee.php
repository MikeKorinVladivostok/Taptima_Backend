...
class __TwigTemplate_e506d8a8ac7e5c4d4ec049a0ba2d9759e0c5239cea29cccd43aced17da356b5f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    ";
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 6, $this->source); })()), 'form', ["action" => $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("WriteBook"), "method" => "POST"]);
        echo "
";
...
{% block body %}
    {{ form(form, {'action': path('WriteBook'), 'method': 'POST'}) }}
{% endblock %}

", "books/index.html.twig", "W:\\domains\\Taptima_Backend\\templates\\books\\index.html.twig");
    }
}
