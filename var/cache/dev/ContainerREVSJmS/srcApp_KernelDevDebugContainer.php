...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'admin.authors.template_registry' => 'getAdmin_Authors_TemplateRegistryService',
    ...
    /**
     * Gets the public 'admin.authors.template_registry' shared service.
     *
     * @return \Sonata\AdminBundle\Templating\MutableTemplateRegistry
     */
    protected function getAdmin_Authors_TemplateRegistryService()
    {
        ...
        return $this->services['admin.authors.template_registry'] = new \Sonata\AdminBundle\Templating\MutableTemplateRegistry($this->parameters['sonata.admin.configuration.templates']);
    }
    ...
    /**
     * Gets the private 'admin.authors' autowired service.
     *
     * @return \App\Admin\CategoryAdmin
     */
    protected function getAdmin_AuthorsService()
    {
        ...
        $instance = new \App\Admin\CategoryAdmin('admin.authors', 'App\\Entity\\Authors', 'sonata.admin.controller.crud');
        ...
        $instance->setLabel('Authors');
        $instance->setListModes(['list' => ['class' => 'fas fa-list fa-fw'], 'mosaic' => ['class' => 'fas fa-th-large fa-fw']]);
        $instance->setTemplateRegistry(($this->services['admin.authors.template_registry'] ?? $this->getAdmin_Authors_TemplateRegistryService()));
    ...
    protected function getSonata_Admin_PoolService()
    {
        return $this->privates['sonata.admin.pool'] = new \Sonata\AdminBundle\Admin\Pool(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'admin.authors' => [false, 'admin.authors', 'getAdmin_AuthorsService', false],
            'admin.books' => [false, 'admin.books', 'getAdmin_BooksService', false],
        ], [
            'admin.authors' => '?',
            'admin.books' => '?',
        ]), [0 => 'admin.authors', 1 => 'admin.books'], ['default' => ['label' => 'default', 'label_catalogue' => 'SonataAdminBundle', 'icon' => 'fas fa-folder', 'items' => [0 => ['admin' => 'admin.authors', 'label' => 'Authors', 'route' => '', 'route_params' => [], 'route_absolute' => false], 1 => ['admin' => 'admin.books', 'label' => 'Books', 'route' => '', 'route_params' => [], 'route_absolute' => false]], 'roles' => [], 'on_top' => false, 'keep_open' => false]], ['App\\Entity\\Authors' => [0 => 'admin.authors'], 'App\\Entity\\Books' => [0 => 'admin.books']]);
    }
