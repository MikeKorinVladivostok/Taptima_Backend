...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder04062 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer3692c = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties4e68e = [
        
    ];

    public function getConnection()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getConnection', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getMetadataFactory', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getExpressionBuilder', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'beginTransaction', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getCache', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getCache();
    }

    public function transactional($func)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'transactional', array('func' => $func), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'wrapInTransaction', array('func' => $func), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'commit', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->commit();
    }

    public function rollback()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'rollback', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getClassMetadata', array('className' => $className), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'createQuery', array('dql' => $dql), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'createNamedQuery', array('name' => $name), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'createQueryBuilder', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'flush', array('entity' => $entity), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'clear', array('entityName' => $entityName), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->clear($entityName);
    }

    public function close()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'close', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->close();
    }

    public function persist($entity)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'persist', array('entity' => $entity), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'remove', array('entity' => $entity), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'refresh', array('entity' => $entity), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'detach', array('entity' => $entity), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'merge', array('entity' => $entity), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getRepository', array('entityName' => $entityName), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'contains', array('entity' => $entity), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getEventManager', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getConfiguration', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'isOpen', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getUnitOfWork', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getProxyFactory', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'initializeObject', array('obj' => $obj), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'getFilters', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'isFiltersStateClean', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'hasFilters', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return $this->valueHolder04062->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer3692c = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder04062) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder04062 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder04062->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, '__get', ['name' => $name], $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        if (isset(self::$publicProperties4e68e[$name])) {
            return $this->valueHolder04062->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder04062;
    ...
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;
    ...
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, '__isset', array('name' => $name), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;
    ...
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, '__unset', array('name' => $name), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;
    ...
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, '__clone', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        $this->valueHolder04062 = clone $this->valueHolder04062;
    }

    public function __sleep()
    {
        $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, '__sleep', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;

        return array('valueHolder04062');
    }
    ...
    {
        $this->initializer3692c = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer3692c;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer3692c && ($this->initializer3692c->__invoke($valueHolder04062, $this, 'initializeProxy', array(), $this->initializer3692c) || 1) && $this->valueHolder04062 = $valueHolder04062;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder04062;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder04062;
    }
