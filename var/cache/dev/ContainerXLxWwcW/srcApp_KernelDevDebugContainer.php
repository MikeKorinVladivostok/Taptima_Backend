...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'admin.category.template_registry' => 'getAdmin_Category_TemplateRegistryService',
    ...
    /**
     * Gets the public 'admin.category.template_registry' shared service.
     *
     * @return \Sonata\AdminBundle\Templating\MutableTemplateRegistry
     */
    protected function getAdmin_Category_TemplateRegistryService()
    {
        ...
        return $this->services['admin.category.template_registry'] = new \Sonata\AdminBundle\Templating\MutableTemplateRegistry($this->parameters['sonata.admin.configuration.templates']);
    }
    ...
    /**
     * Gets the private 'admin.category' autowired service.
     *
    ...
    protected function getAdmin_CategoryService()
    {
        ...
        $instance = new \App\Admin\CategoryAdmin('admin.category', 'App\\Entity\\Category', 'sonata.admin.controller.crud');
        ...
        $instance->setTemplateRegistry(($this->services['admin.category.template_registry'] ?? $this->getAdmin_Category_TemplateRegistryService()));
    ...
    protected function getSonata_Admin_PoolService()
    {
        return $this->privates['sonata.admin.pool'] = new \Sonata\AdminBundle\Admin\Pool(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'admin.category' => [false, 'admin.category', 'getAdmin_CategoryService', false],
        ], [
            'admin.category' => '?',
        ]), [0 => 'admin.category'], ['default' => ['label' => 'default', 'label_catalogue' => 'SonataAdminBundle', 'icon' => 'fas fa-folder', 'items' => [0 => ['admin' => 'admin.category', 'label' => 'Category', 'route' => '', 'route_params' => [], 'route_absolute' => false]], 'roles' => [], 'on_top' => false, 'keep_open' => false]], ['App\\Entity\\Category' => [0 => 'admin.category']]);
    }
