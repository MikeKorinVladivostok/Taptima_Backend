...
return [
    ...
    'admin_app_books_list' => [[], ['_controller' => 'sonata.admin.controller.crud::listAction', '_sonata_admin' => 'admin.books', '_sonata_name' => 'admin_app_books_list'], [], [['text', '/admin/app/books/list']], [], []],
    'admin_app_books_create' => [[], ['_controller' => 'sonata.admin.controller.crud::createAction', '_sonata_admin' => 'admin.books', '_sonata_name' => 'admin_app_books_create'], [], [['text', '/admin/app/books/create']], [], []],
    'admin_app_books_batch' => [[], ['_controller' => 'sonata.admin.controller.crud::batchAction', '_sonata_admin' => 'admin.books', '_sonata_name' => 'admin_app_books_batch'], [], [['text', '/admin/app/books/batch']], [], []],
    'admin_app_books_edit' => [['id'], ['_controller' => 'sonata.admin.controller.crud::editAction', '_sonata_admin' => 'admin.books', '_sonata_name' => 'admin_app_books_edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id'], ['text', '/admin/app/books']], [], []],
    'admin_app_books_delete' => [['id'], ['_controller' => 'sonata.admin.controller.crud::deleteAction', '_sonata_admin' => 'admin.books', '_sonata_name' => 'admin_app_books_delete'], [], [['text', '/delete'], ['variable', '/', '[^/]++', 'id'], ['text', '/admin/app/books']], [], []],
    'admin_app_books_show' => [['id'], ['_controller' => 'sonata.admin.controller.crud::showAction', '_sonata_admin' => 'admin.books', '_sonata_name' => 'admin_app_books_show'], [], [['text', '/show'], ['variable', '/', '[^/]++', 'id'], ['text', '/admin/app/books']], [], []],
    'admin_app_books_export' => [[], ['_controller' => 'sonata.admin.controller.crud::exportAction', '_sonata_admin' => 'admin.books', '_sonata_name' => 'admin_app_books_export'], [], [['text', '/admin/app/books/export']], [], []],
